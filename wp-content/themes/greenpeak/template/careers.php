            ...
            <section class="contact-form-wrapper"
                ...
                <div class="container">
                    <div class="row  contact-desc">
                        <div class="col-12">
                            <p>Green Peak is seeking professionals with an unusually high blend of EQ and IQ, a deep
                                curiosity about people, and a passion for leadership and organizational development.
                                You must be prepared to fasten your seat belt, take your own game to the next level
                                and have a blast doing it. If you are interested in learning more about our unique
                                team, contact us below.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form class="contact-form">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="exampleInpuName"
                                           aria-describedby="namelHelp"
                                           placeholder="Name">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" id="exampleInpuEmail"
