...
get_header(); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="column">
                <img class=" cursor"
                     src="<?php echo get_template_directory_uri(); ?>/assets/videos/Green-Peak-Summer-Retreat-2018.mp4"
                     style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
            </div>
            <div class="column">
                <img class="demo cursor" src="<?php echo get_template_directory_uri(); ?>/assets/images/GPHome_How.jpg"
                     style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
            </div>
            <div class="column">
                <img class="demo cursor"
                     src="<?php echo get_template_directory_uri(); ?>/assets/images/ContactBridge.jpg"
            ...
            <div class="cd-testimonials-wrapper cd-container"
                ...
                <ul class="cd-testimonials">
                    ...
                    <li>
                        <div class="testimonial-content">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sed diam eget risus
                                varius blandit sit amet non magna. Cras mattis consectetur purus sit amet fermentum.</p>
                            <div class="cd-author">
                                <img src="http://placehold.it/350x350/222222/222222" alt="Author image">
                                <ul class="cd-author-info">
                                    <li>Lorem<strong>Ipsum</strong><br><span>@twitterhandle</span></li>
